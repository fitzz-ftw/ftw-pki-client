...
try:
    from ftwpki.client._version import __version__  # noqa: I001
    version = __version__ 
    release = __version__ 
except ImportError:
...
if "epub" in sys.argv:
    epub_cover = render_cover("ftw-client", version.split("+")[0])
...
# epub_identifier = 'https://github.com/ftwpki.client.git'
epub_scheme = 'URL'
