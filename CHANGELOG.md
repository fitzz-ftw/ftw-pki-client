...
### Changed
- Migrate client module to workflow pattern
- Refactor CLI handling and CSR creation process
- Implement TomlPreParser for client certificate request programs
- Rename legacy TOML functions to modernize utility interfaces

### Fixed
- Improve parser robustness and migrate to -dns argument

### Documentation
- Standardize configuration flags and update developer documentation

### Removed
- Remove deprecated cli_user documentation
